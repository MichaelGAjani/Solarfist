namespace Jund.MailHelper
{
    ...
    public class MimeEntity
    {
        ...
        private AlternateView CreateAlternateView(MimeEntity view) => 
            new AlternateView(view.Content, view.ContentType) { 
        ...
        private static bool IsAttachment(MimeEntity child) => 
            ((child.ContentDisposition != null) && string.Equals(child.ContentDisposition.DispositionType, "attachment", StringComparison.InvariantCultureIgnoreCase));
        ...
        public StringBuilder EncodedMessage =>
            this._encodedMessage;

        public string EndBoundary =>
            (this.StartBoundary + "--");

        internal bool HasBoundary =>
            (!string.IsNullOrEmpty(this._contentType.Boundary) || !string.IsNullOrEmpty(this._startBoundary));
