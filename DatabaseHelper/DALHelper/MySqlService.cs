...
namespace Jund.DatabaseHelper.DALHelper
{
    ...
    public class MySqlService
    {
        ...
        public MySqlService(string server, string database, string user, string password)
        {
            //Server=myServerAddress;Option=131072;Stmt=;Database=myDataBase; User=myUsername;Password=myPassword;
            this.ConnectionString = "Server="+server+";Data Source=" + database + ";User ID=" + user + ";Password=" + password + ";";
        }

        public MySqlService(MySqlConnection connection)
        {
        ...
        public MySqlParameter AddTextParameter(string name, string value)
        {
            ...
            prm.Direction = ParameterDirection.Input;
            prm.ParameterName = name;
            prm.MySqlDbType = MySqlDbType.Blob;
            prm.Value = this.PrepareSqlValue(value);
        ...
        public void RemoveParameters(MySqlParameter para)
        {
            this._parameters.Remove(para);
        }

        public MySqlParameter FindParameter(string name)
        {
            MySqlParameter pm = null;
