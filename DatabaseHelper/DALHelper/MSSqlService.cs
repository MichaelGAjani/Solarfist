...
namespace Jund.DatabaseHelper.DALHelper
{
    ...
    public class MSSqlService
    {
        ...
        public MSSqlService(string server, string database, string user, string password)
        {
            this.ConnectionString = "Server=" + server + ";Database=" + database + ";User ID=" + user + ";Password=" + password + ";";
        }

        public MSSqlService(string server, string database)
        {
            this.ConnectionString = "Server=" + server + ";Database=" + database + ";Integrated Security=true;";
        }

        public MSSqlService(SqlConnection connection)
        {
