namespace Jund.OpcHelper.Opc
{
    ...
    public class Type
    {
        ...
        public static System.Type ILLEGAL_TYPE = typeof(Opc.Type);
        ...
        public static System.Type[] Enumerate()
        {
            ...
            foreach (FieldInfo info in typeof(Opc.Type).GetFields(BindingFlags.Public | BindingFlags.Static))
            {
                list.Add(info.GetValue(typeof(System.Type)));
            }
